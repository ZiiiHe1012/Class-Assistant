...
export const config = Object.freeze({
  ...
  openaiModel: process.env.OPENAI_MODEL || 'openai/gpt-5.5',
  openaiModelFast: process.env.OPENAI_MODEL_FAST || process.env.OPENAI_MODEL || 'openai/gpt-5.5',
  openaiModelDeep: process.env.OPENAI_MODEL_DEEP || process.env.OPENAI_MODEL || 'openai/gpt-5.5',
  guiAgentEnabled: getBooleanEnv('GUI_AGENT_ENABLED', false),
  guiAgentModel: process.env.GUI_AGENT_MODEL || process.env.OPENAI_MODEL_FAST || process.env.OPENAI_MODEL || 'openai/gpt-5.5',
  ...
  translateModel: process.env.TRANSLATE_MODEL || process.env.OPENAI_MODEL_FAST || process.env.OPENAI_MODEL || 'openai/gpt-5.5',
